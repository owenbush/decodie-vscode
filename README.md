...
For richer documentation, install the [Decodie skills](https://github.com/owenbush/decodie-skill). They provide real-time documentation, retroactive analysis, overviews, and more — compatible with Claude Code, Gemini CLI, Cursor, and 70+ other agents.
