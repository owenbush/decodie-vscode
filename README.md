...
For richer documentation, install the [Decodie skill](https://github.com/owenbush/decodie-skill). It provides modes for real-time documentation, retroactive analysis, overviews, and more — compatible with Claude Code, Gemini CLI, Cursor, and 70+ other agents.
